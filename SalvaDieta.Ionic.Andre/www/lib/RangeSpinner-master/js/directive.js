...
.run(['$templateCache',function($templateCache){
	$templateCache.put('tmpl/rangeSpinner.html',
		'<div class="rangespinner"> \
			<div> \
				<button type="button" class="button button-balanced" ng-click="rangeMinusFunc()">-</button> \
				...
				<button type="button" class="button button-balanced" ng-click="rangePlusFunc()">+</button>\
			</div> \
		</div>');
}]);