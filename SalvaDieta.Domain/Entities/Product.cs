...
namespace SalvaDieta.Domain.Entities
{
    public class Product
    {
        ...
        public void UpdateInfo(string title, string description, string weight, decimal price, int quantityOnHand, int category, string image)
        {
            if (!this.UpdateProductScopeIsValid(title, description, category))
                return;
