...
namespace SalvaDieta.CrossCutting
{
    public static class DependencyRegister
    {
        ...
        public static void Register(UnityContainer container)
        {
            ...
            container.RegisterType<IDayRepository, DayRepository>(new HierarchicalLifetimeManager());
            container.RegisterType<IHourRepository, HourRepository>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IDayApplicationService, DayApplicationService>(new HierarchicalLifetimeManager());
            container.RegisterType<IHourApplicationService, HourApplicationService>(new HierarchicalLifetimeManager());
